...
function LoginForm() {
    ...
    return (
        <form className="md:w-96 w-80 flex flex-col items-center justify-center">
            ...
            <p className="text-gray-500/90 text-sm mt-4">Don’t have an account? <Link className="text-primary hover:underline" href="/signup">Sign up</Link></p>
        </form>
    )
}
