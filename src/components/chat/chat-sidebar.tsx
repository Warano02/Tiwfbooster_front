    ...
    <div className="flex h-full w-full flex-col bg-sidebar border-r border-sidebar-border">
      ...
      <div className="p-5 border-t border-sidebar-border">
        <div className="rounded-lg bg-linear-to-br from-purple-500/10 via-blue-500/10 to-pink-500/10 p-3.5 space-y-3">
          ...
          <Button
            size="sm"
            className="relative w-fit h-7.5 px-3 overflow-hidden bg-white text-black hover:bg-white/90 shadow-[0px_1px_2px_0px_rgba(8,8,8,0.2),0px_4px_4px_0px_rgba(8,8,8,0.08),inset_0px_1px_1px_0px_rgba(255,255,255,0.2),inset_0px_6px_12px_0px_rgba(255,255,255,0.12)]"
            asChild
          >
            <Link
